...
call joeconf#mapping#major#define("uvi", ":tab drop ~/.config/nvim/init.vim<CR>", "Init.vim")
call joeconf#mapping#major#define("uvp", ":tab drop ~/.config/nvim/pack/joeconf/start/joeconf/Plugins.vim<CR>", "Plugins.vim")
call joeconf#mapping#major#define("uvc", ":tab drop ~/.config/nvim/pack/joeconf/start/joeconf/Commands.vim<CR>", "Commands.vim")
call joeconf#mapping#major#define("uvm", ":tab drop ~/.config/nvim/pack/joeconf/start/joeconf/plugins/mappings/major.vim<CR>", "Mappings")
